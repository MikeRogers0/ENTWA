...
import entwa.entities.People;
import entwa.jsf.util.JsfUtil;
import entwa.jsf.util.PaginationHelper;
import entwa.beans.PeopleFacade;
...
public class PeopleController implements Serializable {
    ...
    @EJB
    private entwa.beans.PeopleFacade ejbFacade;
